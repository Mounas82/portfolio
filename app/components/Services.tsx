  ...
  return (
    <div className='flex flex-col '> 
        <div className='flex flex-col justify-center text-center gap-8 mr-52 ml-52 mt-16'>
            ...
            <div> Explore my design services, from user interface and experience to prototyping and testing. Let's craft exceptional digital experiences together. </div>
        </div>
        <div className='flex flex-row justify-between gap-6 mr-20 ml-20 mt-10'>
            ...
            <div className='flex flex-col w-60 justify-center gap-8' >
                ...
                <div>I'm a branding expert, crafting unique visual identities that tell your story and resonate with your audience.</div>
            </div>
            <div className='flex flex-col w-60 justify-center gap-8' >
                <div> 
