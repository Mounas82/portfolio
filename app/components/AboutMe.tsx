  ...
  return (
    <div className='flex flex-col bg-black'> 
        <div className='text-white text-center justify-center '> 
            ...
            <div className='mr-60 ml-60'><p>  Im Muhammad Mounas Samim a UI/UX designer dedicated to crafting intuitive and visually stunning digital experiences. With a passion for user-centric design, I transform ideas into functional and beautiful interfaces. Lets collaborate and shape the future of design together. </p></div>
        </div>
